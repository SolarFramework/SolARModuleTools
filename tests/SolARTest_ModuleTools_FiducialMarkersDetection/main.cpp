...
int main(int argc, char* argv[])
{
    ...
    if (xpcfComponentManager->load("SolARTest_ModuleTools_FiducialMarkersDetection_conf.xml") != org::bcom::xpcf::_SUCCESS)
	{
        std::cerr << "Failed to load the configuration file SolARTest_ModuleTools_FiducialMarkersDetection_conf.xml" << std::endl;
		return -1;
	}
	...
	std::vector<SRef<Trackable>> fiducialMarkers;
    ...
    // set fiducial markers to detector
    trackablesDetector->setTrackables(fiducialMarkers);
