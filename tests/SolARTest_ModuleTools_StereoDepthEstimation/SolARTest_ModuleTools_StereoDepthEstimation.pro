...
TARGET = SolARTest_ModuleTools_StereoDepthEstimation
VERSION=1.0.0
...
configfile.files = $$files($${PWD}/SolARTest_ModuleTools_StereoDepthEstimation_conf.xml)
INSTALLS += configfile
...
DISTFILES += \
    ...
    SolARTest_ModuleTools_StereoDepthEstimation_conf.xml \
